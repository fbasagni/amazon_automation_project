...
public class GeraCPF {
    public  ArrayList<Integer> listaAleatoria = new ArrayList<Integer>();
    public  ArrayList<Integer> listaNumMultiplicados = null;
    ...
    public String geraCpfSemCaractereEspecial() {
        String cpf = geraCPFFinal();
